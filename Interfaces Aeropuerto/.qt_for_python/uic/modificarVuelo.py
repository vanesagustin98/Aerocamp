...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.bt_modificar_vuelo = QPushButton(self.centralwidget)
        self.bt_modificar_vuelo.setObjectName(u"bt_modificar_vuelo")
        self.bt_modificar_vuelo.setGeometry(QRect(220, 350, 141, 51))
        font = QFont()
        font.setBold(True)
        font.setWeight(75)
        self.bt_modificar_vuelo.setFont(font)
        self.bt_modificar_vuelo.setStyleSheet(u"background-color: rgb(170, 170, 255);")
        self.formLayoutWidget_6 = QWidget(self.centralwidget)
        self.formLayoutWidget_6.setObjectName(u"formLayoutWidget_6")
        self.formLayoutWidget_6.setGeometry(QRect(60, 170, 224, 144))
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"Modificar Datos del Vuelo", None))
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><br/></p></body></html>", None))
        self.bt_modificar_vuelo.setText(QCoreApplication.translate("MainWindow", u"Confirmar Datos", None))
