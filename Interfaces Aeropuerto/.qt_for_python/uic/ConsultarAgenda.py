...
class Ui_Agenda(object):
    def setupUi(self, Agenda):
        ...
        self.tableWidget.setGeometry(QRect(45, 121, 501, 231))
        self.tableWidget.setStyleSheet(u"background-color: rgb(255, 255, 255);")
        self.label = QLabel(self.centralwidget)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(50, 20, 201, 16))
    ...
    def retranslateUi(self, Agenda):
        ...
        self.label.setText(QCoreApplication.translate("Agenda", u"<html><head/><body><p><span style=\" font-size:10pt; font-weight:600;\">Selecciona la Fecha de Vuelo</span></p></body></html>", None))
    # retranslateUi
