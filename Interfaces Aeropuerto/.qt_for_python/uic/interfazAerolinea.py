...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.bt_programarVuelo.setGeometry(QRect(30, 230, 121, 51))
        font = QFont()
        font.setPointSize(9)
        ...
        self.bt_solicitarAgendamiento.setGeometry(QRect(420, 230, 131, 51))
        ...
        self.bt_visualizarDatos.setEnabled(True)
        self.bt_visualizarDatos.setGeometry(QRect(290, 230, 121, 51))
        ...
        self.bt_cerrarSesion.setGeometry(QRect(460, 300, 91, 31))
        font1 = QFont()
        font1.setBold(True)
        font1.setWeight(75)
...
"color: rgb(85, 0, 127);")
        ...
        self.pushButton.setGeometry(QRect(160, 230, 121, 51))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(QCoreApplication.translate("MainWindow", u"Visualizar Vuelos", None))
    # retranslateUi
